...
namespace SBMS.Controllers
{
    public class ReportingController : Controller
    {
        ...
        public ActionResult PeriodictIncomeReport(ProductViewModel productViewModel)
        {
            ...
            var sale = Mapper.Map<ProductVM>(productViewModel);
            var salesProducts = _reportingManager.PeriodictIncomeReport(sale);
        ...
        public ActionResult PeriodicIncomeExpenseOnPurchase(ProductViewModel productViewModel)
        {
            ...
            var x = Mapper.Map<ProductVM>(productViewModel);
            var purchaseProducts = _reportingManager.PeriodictIncomeReportOnPurchase(x);
